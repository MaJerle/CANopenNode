...
typedef struct {
     ...
     * @return Value from @ref ODR_t, "ODR_OK" in case of success.
     */
    ODR_t (*write)(OD_stream_t *stream,
                   const void *buf,
                   OD_size_t count,
...
{
    return (stream != NULL)
               ? (stream->attribute & (ODA_TRPDO | ODA_TRSRDO)) != 0
               : false;
}
...
static inline ODR_t OD_get_i16(const OD_entry_t *entry,
                               uint8_t subIndex,
                               int16_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_get_i32(const OD_entry_t *entry,
                               uint8_t subIndex,
                               int32_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_get_i64(const OD_entry_t *entry,
                               uint8_t subIndex,
                               int64_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_get_u8(const OD_entry_t *entry,
                              uint8_t subIndex,
                              uint8_t *val,
                              bool_t odOrig)
{
...
static inline ODR_t OD_get_u16(const OD_entry_t *entry,
                               uint8_t subIndex,
                               uint16_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_get_u32(const OD_entry_t *entry,
                               uint8_t subIndex,
                               uint32_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_get_u64(const OD_entry_t *entry,
                               uint8_t subIndex,
                               uint64_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_get_f32(const OD_entry_t *entry,
                               uint8_t subIndex,
                               float32_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_get_f64(const OD_entry_t *entry,
                               uint8_t subIndex,
                               float64_t *val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_set_i16(const OD_entry_t *entry,
                               uint8_t subIndex,
                               int16_t val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_set_i32(const OD_entry_t *entry,
                               uint8_t subIndex,
                               int32_t val,
                               bool_t odOrig)
{
...
/** Set int32_t variable in Object Dictionary, see @ref OD_set_value */
static inline ODR_t OD_set_i64(const OD_entry_t *entry,
                               uint8_t subIndex,
                               int64_t val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_set_u16(const OD_entry_t *entry,
                               uint8_t subIndex,
                               uint16_t val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_set_u32(const OD_entry_t *entry,
                               uint8_t subIndex,
                               uint32_t val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_set_u64(const OD_entry_t *entry,
                               uint8_t subIndex,
                               uint64_t val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_set_f32(const OD_entry_t *entry,
                               uint8_t subIndex,
                               float32_t val,
                               bool_t odOrig)
{
...
static inline ODR_t OD_set_f64(const OD_entry_t *entry,
                               uint8_t subIndex,
                               float64_t val,
                               bool_t odOrig)
{
