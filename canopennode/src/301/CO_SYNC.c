 ...
 */
static ODR_t OD_write_1005(OD_stream_t *stream,
                           const void *buf,
                           OD_size_t count,
 ...
 * For more information see file CO_ODinterface.h, OD_IO_t.
 */
static ODR_t OD_write_1019(OD_stream_t *stream,
                           const void *buf,
                           OD_size_t count,
                           OD_size_t *countWritten)
{
                              ...
                              uint32_t *errInfo)
{
    ...
    SYNC->OD_1006_period =
        OD_getPtr(OD_1006_commCyclePeriod, 0, sizeof(uint32_t), NULL);
#if (CO_CONFIG_SYNC) & CO_CONFIG_SYNC_PRODUCER
    ...
    SYNC->OD_1007_window =
        OD_getPtr(OD_1007_syncWindowLen, 0, sizeof(uint32_t), NULL);
                                 ...
                                 uint32_t *timerNext_us)
{
    ...
    if (NMTisPreOrOperational) {
        ...
        uint32_t OD_1006_period =
            SYNC->OD_1006_period != NULL ? *SYNC->OD_1006_period : 0;
            ...
            if (SYNC->isProducer) {
                ...
                if (SYNC->timeoutError == 1) {
                    ...
                    uint32_t periodTimeout =
                        OD_1006_period + (OD_1006_period >> 1);
