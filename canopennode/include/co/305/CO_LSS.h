...
typedef enum {
    ...
    CO_LSS_SWITCH_STATE_SEL_VENDOR =
        0x40U, /**< Switch state selective protocol - Vendor ID */
    CO_LSS_SWITCH_STATE_SEL_PRODUCT =
        0x41U, /**< Switch state selective protocol - Product code */
    CO_LSS_SWITCH_STATE_SEL_REV =
        0x42U, /**< Switch state selective protocol - Revision number */
    CO_LSS_SWITCH_STATE_SEL_SERIAL =
        0x43U, /**< Switch state selective protocol - Serial number */
    CO_LSS_SWITCH_STATE_SEL =
        0x44U, /**< Switch state selective protocol - Slave response */
    CO_LSS_CFG_NODE_ID = 0x11U, /**< Configure node ID protocol */
    CO_LSS_CFG_BIT_TIMING =
        0x13U, /**< Configure bit timing parameter protocol */
    CO_LSS_CFG_ACTIVATE_BIT_TIMING =
        0x15U,                  /**< Activate bit timing parameter protocol */
    ...
    CO_LSS_INQUIRE_PRODUCT =
        0x5BU, /**< Inquire identity product-code protocol */
    CO_LSS_INQUIRE_REV =
        0x5CU, /**< Inquire identity revision-number protocol */
    CO_LSS_INQUIRE_SERIAL =
        0x5DU, /**< Inquire identity serial-number protocol */
...
typedef enum {
    ...
    CO_LSS_CFG_NODE_ID_MANUFACTURER =
        0xFFU /**< Manufacturer specific error. No further support */
} CO_LSS_cfgNodeId_t;
...
typedef enum {
    ...
    CO_LSS_CFG_BIT_TIMING_OUT_OF_RANGE =
        0x01U, /**< Bit timing / Bit rate not supported */
...
typedef enum {
    ...
    CO_LSS_CFG_STORE_NOT_SUPPORTED =
        0x01U,                       /**< Store configuration not supported */
 ...
 */
typedef enum {
    CO_LSS_FASTSCAN_BIT0 = 0x00U, /**< Least significant bit of IDnumbners bit
                                     area to be checked */
    /* ... */
    CO_LSS_FASTSCAN_BIT31 = 0x1FU,  /**< dito */
    CO_LSS_FASTSCAN_CONFIRM = 0x80U /**< All LSS slaves waiting for scan respond
                                       and previous scan is reset */
 ...
 * - LSS configuration: In this state variables may be configured in the LSS
 * slave.
...
static const uint16_t CO_LSS_bitTimingTableLookup[] = {
    1000, 800, 500, 250, 125, 0, 50, 20, 10, 0};
 ...
 */
#define CO_LSS_NODE_ID_VALID(nid)                                              \
    ((nid >= 1 && nid <= 0x7F) || nid == CO_LSS_NODE_ID_ASSIGNMENT)
