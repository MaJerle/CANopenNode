...
/**
 * @defgroup CO_STACK_CONFIG_NODE_GUARDING CANopen Node Guarding slave and
 * master objects. Specified in standard CiA 301
 * @{
 */
/**
...
#ifndef CO_CONFIG_EM
#define CO_CONFIG_EM                                                           \
    (CO_CONFIG_EM_PRODUCER | CO_CONFIG_EM_HISTORY |                            \
     CO_CONFIG_GLOBAL_FLAG_CALLBACK_PRE | CO_CONFIG_GLOBAL_FLAG_TIMERNEXT)
#endif
...
#define CO_CONFIG_ERR_CONDITION_MANUFACTURER                                   \
    (em->errorStatusBits[8] || em->errorStatusBits[9])
#endif
...
#define CO_CONFIG_STORAGE 0 /* (CO_CONFIG_STORAGE_ENABLE) */
#endif
